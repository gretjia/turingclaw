...
export default function App() {
  ...
  const [agentState, setAgentState] = useState<'idle' | 'thinking' | 'executing'>('idle');
      ...
      <div className="w-64 border-r border-[#00ff00]/30 flex flex-col bg-[#050505]">
        ...
        <div className="p-4 border-t border-[#00ff00]/30 bg-[#0a0a0a]">
          ...
          <div className="flex items-center gap-3">
            <Cpu size={20} className={agentState === 'thinking' ? 'animate-pulse text-yellow-400' : agentState === 'executing' ? 'animate-spin text-red-500' : 'text-[#00ff00]'} />
            <span className={`text-sm font-bold uppercase ${agentState === 'thinking' ? 'text-yellow-400' : agentState === 'executing' ? 'text-red-500' : 'text-[#00ff00]'}`}>
              {agentState}
            </span>
          </div>
        </div>
